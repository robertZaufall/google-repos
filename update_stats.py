#!/usr/bin/env python3
"""
Build and refresh the Google GitHub repository catalog.

The script fetches public GitHub metadata for repositories in Google's
google organization that were updated in the last three months and have more
...
USER_AGENT = "google-repos-catalog"
AUTO_KEYWORD_TERMS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ...
    ("Privacy", ("privacy", "confidential computing", "encryption")),
    ("Graphics", ("graphics", "rendering", "shader")),
    ("Media", ("video", "audio", "codec")),
    ("Optimization", ("optimization", "operations research", "solver")),
...
CLUSTERS: tuple[Cluster, ...] = (
    Cluster(
        ...
        "Agent frameworks, foundation models, machine learning libraries, model evaluation, and AI applications.",
        "blue",
        (
            "agent",
    ...
    Cluster(
        ...
        "Languages, SDKs & Core Libraries",
        "Programming languages, compilers, command-line tools, SDKs, testing frameworks, and reusable libraries.",
        "purple",
        (
            "api",
            "cli",
    ...
    Cluster(
        ...
        "Cloud, Containers & Distributed Systems",
        "Cloud-native infrastructure, containers, networking, operating systems, storage, and distributed services.",
        "cyan",
        (
            "cloud",
            "container",
    ...
    Cluster(
        ...
        "Security, Privacy & Reliability",
        "Fuzzing, vulnerability management, cryptography, privacy, sandboxing, and production reliability.",
        "green",
        (
            "cryptography",
            "encryption",
    ...
    Cluster(
        ...
        "Android, Web & Product Platforms",
        "Android, browser, web, mobile, identity, commerce, and product-facing developer platforms.",
        "yellow",
        (
            "android",
            "browser",
    ...
    Cluster(
        "graphics-media-xr",
        "Graphics, Media & XR",
        "Rendering engines, graphics APIs, fonts, codecs, media pipelines, 3D, and immersive experiences.",
        "red",
        (
            "3d",
            "audio",
    ...
    Cluster(
        ...
        "Data, Science & Optimization",
        "Data systems, operations research, scientific computing, health, geospatial tooling, and quantitative methods.",
        "orange",
        (
            "analytics",
            "data",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Update Google GitHub repository catalog.")
...
def cluster_repo(repo: dict[str, Any]) -> Cluster:
    ...
    name_overrides = {
        ...
        "ax": "ai-agents-ml",
        "brax": "ai-agents-ml",
        "edward2": "ai-agents-ml",
        "fedjax": "ai-agents-ml",
        "ffn": "ai-agents-ml",
        "flax": "ai-agents-ml",
        "gemma.cpp": "ai-agents-ml",
        "langfun": "ai-agents-ml",
        "langextract": "ai-agents-ml",
        "magika": "ai-agents-ml",
        "mcp": "ai-agents-ml",
        "ml-compiler-opt": "ai-agents-ml",
        "ml_collections": "ai-agents-ml",
        "orbax": "ai-agents-ml",
        "paxml": "ai-agents-ml",
        "pyglove": "ai-agents-ml",
        "ruy": "ai-agents-ml",
        "seqio": "ai-agents-ml",
        "sentencepiece": "ai-agents-ml",
        "skills": "ai-agents-ml",
        "praxis": "ai-agents-ml",
        "rax": "ai-agents-ml",
        "sam": "ai-agents-ml",
        "torchax": "ai-agents-ml",
        "tunix": "ai-agents-ml",
        "xnnpack": "ai-agents-ml",
        "yggdrasil-decision-forests": "ai-agents-ml",
        "allocation-instrumenter": "languages-sdks-libraries",
        "auto": "languages-sdks-libraries",
        "brotli": "languages-sdks-libraries",
        "built_collection.dart": "languages-sdks-libraries",
        "built_value.dart": "languages-sdks-libraries",
        "commonlooputils": "ai-agents-ml",
        "comprehensive-rust": "languages-sdks-libraries",
        "double-conversion": "languages-sdks-libraries",
        "etils": "languages-sdks-libraries",
        "farmhash": "languages-sdks-libraries",
        "flatbuffers": "languages-sdks-libraries",
        "go-cmp": "languages-sdks-libraries",
        "gson": "languages-sdks-libraries",
        "guava": "languages-sdks-libraries",
        "googletest": "languages-sdks-libraries",
        "go-github": "languages-sdks-libraries",
        "go-jsonnet": "languages-sdks-libraries",
        "googlesql": "data-science-optimization",
        "json_serializable.dart": "languages-sdks-libraries",
        "libphonenumber": "languages-sdks-libraries",
        "mozc": "languages-sdks-libraries",
        "python-fire": "languages-sdks-libraries",
        "riegeli": "languages-sdks-libraries",
        "snappy": "languages-sdks-libraries",
        "starlark-go": "languages-sdks-libraries",
        "styleguide": "languages-sdks-libraries",
        "wireit": "languages-sdks-libraries",
        "zx": "languages-sdks-libraries",
        "alioth": "cloud-containers-systems",
        "android-emulator-container-scripts": "cloud-containers-systems",
        "cadvisor": "cloud-containers-systems",
        "crosvm": "cloud-containers-systems",
        "fuse-archive": "cloud-containers-systems",
        "go-cloud": "cloud-containers-systems",
        "go-containerregistry": "cloud-containers-systems",
        "gvisor": "cloud-containers-systems",
        "inverting-proxy": "cloud-containers-systems",
        "nomulus": "cloud-containers-systems",
        "packetdrill": "cloud-containers-systems",
        "quiche": "cloud-containers-systems",
        "tcmalloc": "cloud-containers-systems",
        "atheris": "security-privacy-reliability",
        "bindiff": "security-privacy-reliability",
        "boringssl": "security-privacy-reliability",
        "breakpad": "security-privacy-reliability",
        "bughunters": "security-privacy-reliability",
        "capslock": "security-privacy-reliability",
        "certificate-transparency-go": "security-privacy-reliability",
        "clusterfuzz": "security-privacy-reliability",
        "csp-evaluator": "security-privacy-reliability",
        "der-ascii": "security-privacy-reliability",
        "go-attestation": "security-privacy-reliability",
        "go-tpm": "security-privacy-reliability",
        "go-tpm-tools": "security-privacy-reliability",
        "gwpsan": "security-privacy-reliability",
        "heir": "security-privacy-reliability",
        "longfellow-zk": "security-privacy-reliability",
        "mantis": "security-privacy-reliability",
        "nsjail": "security-privacy-reliability",
        "oss-fuzz": "security-privacy-reliability",
        "oss-rebuild": "security-privacy-reliability",
        "osv-scalibr": "security-privacy-reliability",
        "osv-scanner": "security-privacy-reliability",
        "private-compute-services": "security-privacy-reliability",
        "safehtml": "security-privacy-reliability",
        "sanitizers": "security-privacy-reliability",
        ...
        "dawn": "graphics-media-xr",
        "draco": "graphics-media-xr",
        "fonts": "graphics-media-xr",
        "filament": "graphics-media-xr",
        "jpegli": "graphics-media-xr",
        "libultrahdr": "graphics-media-xr",
        "model-viewer": "graphics-media-xr",
        ...
        "horologist": "android-web-platforms",
        "ksp": "android-web-platforms",
        "material-design-icons": "android-web-platforms",
        "material-design-lite": "android-web-platforms",
        "nearby": "android-web-platforms",
        "site-kit-wp": "android-web-platforms",
        "visualblocks": "android-web-platforms",
        "earthengine-api": "data-science-optimization",
        "earthengine-community": "data-science-optimization",
        "fhir": "data-science-optimization",
        "gnm": "graphics-media-xr",
        "grain": "data-science-optimization",
        "jax-cfd": "data-science-optimization",
        "jaxopt": "data-science-optimization",
        "learned_optimization": "data-science-optimization",
        "meridian": "data-science-optimization",
        "ml-metadata": "data-science-optimization",
        "neuroglancer": "data-science-optimization",
        "or-tools": "data-science-optimization",
        "s2geometry": "data-science-optimization",
        "tensorstore": "data-science-optimization",
        "vizier": "data-science-optimization",
    }
...
<title>Google GitHub Repository Atlas</title>
...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .footer a {{ color: var(--google); text-decoration: none; }}
...
<body>
  <header class="header page-header">
    <h1 class="page-title"><span class="logo-box">G</span>Google GitHub Repository Atlas</h1>
    <p>Searchable snapshot of public repositories from Google's <a href="https://github.com/orgs/google/repositories" target="_blank" rel="noreferrer">google organization</a>. Included repositories have more than 200 stars and were pushed within the last three months, since {cutoff}.</p>
...
{extra_section_html}
  ...
  <footer class="footer">
    <p style="margin-bottom: 10px;">Useful links:
      <a class="gh-link" href="https://opensource.google/" target="_blank" rel="noreferrer" style="display: inline; margin-left: 6px;">Google Open Source</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://research.google/" target="_blank" rel="noreferrer" style="display: inline;">Google Research</a>
      <span style="margin: 0 4px;">·</span>
      <a class="gh-link" href="https://developers.google.com/" target="_blank" rel="noreferrer" style="display: inline;">Google for Developers</a>
    </p>
...
def main() -> int:
    ...
    print(f"Wrote {args.file} with {len(repos)} Google repositories")
