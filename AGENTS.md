...
This file is the working guide for agents editing `google-repos`.

## What this repo is

`google-repos` is a single-page static catalog of public repositories from
Google's `google` GitHub organization. It follows a
...
- `cloudflare/worker.js`: proxy used for
  `https://glaubi.net/google`.

## Catalog rules

Included repositories must be:

- Owned by the `google` GitHub org.
...
2. Languages, SDKs & Core Libraries
3. Cloud, Containers & Distributed Systems
4. Security, Privacy & Reliability
5. Android, Web & Product Platforms
6. Graphics, Media & XR
7. Data, Science & Optimization
...
That command queries GitHub for current `google` repositories
