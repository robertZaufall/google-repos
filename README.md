...
`google-repos` is a static catalog of active repositories from Google's
`google` GitHub organization. It groups public repositories by purpose and
...
The seven clusters cover AI and agents, languages and SDKs, cloud and
distributed systems, security and privacy, Android and web platforms, graphics
and media, and data/science/optimization.
...
- `favicon.svg` - Google-themed favicon.
...
- `cloudflare/worker.js` - proxies the site at `https://glaubi.net/google`.
